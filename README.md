...
4. 运行完整分析（真实社论 + 免费行情 + DeepSeek）
```powershell
uv run python -m src.analyze --provider deepseek --price-source auto --ticker 5591 --input data/editorials/5591 --from-date 2026-01-01 --to-date 2026-05-01 --out outputs
```
